...
const copy = {
  ...
  es: {
    ...
    mapCaption: "De la montaña al puerto de Gandía", mapHint: "Amplía el mapa o toca un grupo para descubrir las paradas.", back: "Volver a la ruta", listen: "Escuchar la audioguía", audioSoon: "Audio disponible próximamente", heritage: "Patrimonio ferroviario", viewPoint: "Ver punto", surveyEyebrow: "Tu opinión", surveyTitle: "Ayúdanos a mejorar la experiencia", surveyText: "Responde esta breve encuesta y comparte con nosotros tu opinión sobre el proyecto.", surveyAction: "Responder la encuesta",
  ...
  en: {
    ...
    mapCaption: "From the mountains to Gandia port", mapHint: "Zoom into the map or tap a cluster to discover the stops.", back: "Back to the route", listen: "Listen to the audio guide", audioSoon: "Audio coming soon", heritage: "Railway heritage", viewPoint: "View place", surveyEyebrow: "Your opinion", surveyTitle: "Help us improve the experience", surveyText: "Take this short survey and share your thoughts about the project with us.", surveyAction: "Take the survey",

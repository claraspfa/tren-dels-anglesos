...
const audioByGuide: Record<GuideKey, string> = {
  station: "/audio/estacions.m4a",
  bridge: "/audio/ponts.m4a",
  tunnel: "/audio/tunels.m4a",
  hut: "/audio/caselles.m4a",
  waterDepot: "/audio/diposits-aigua.m4a",
  locomotiveDepot: "/audio/diposits-locomotores.m4a",
  dock: "/audio/molls.m4a",
};
const welcomeAudio = "/audio/benvinguda.m4a";
...
const POIS: Point[] = [
  ...
  { id: "segona-estacio-alcoi", lat: 38.70638, lon: -0.47178, name: "Segona estació d'Alcoi", group: "station", lost: true, image: "/photos/inventory/alcoi.jpg" },
  { id: "pont-ferro", lat: 38.95802, lon: -0.18205, name: "Pont de ferro", group: "bridge", image: "/photos/inventory/pont-ferro.jpg" },
  { id: "pont-tancaes", lat: 38.8862, lon: -0.23035, name: "Pont de Tancaes", group: "bridge", image: "/photos/inventory/pont-tancaes.jpg" },
  ...
  { id: "pont-beniarres", lat: 38.81882, lon: -0.38739, name: "Pont de Beniarrés", group: "bridge", image: "/photos/inventory/pont-beniarres.jpg" },
  { id: "gran-pont-muro", lat: 38.78662, lon: -0.44102, name: "Gran pont de Muro", group: "bridge", image: "/photos/inventory/gran-pont-muro.jpg" },
  { id: "pont-barranc-morata", lat: 38.90652, lon: -0.20638, name: "Pont del barranc del Morata", group: "bridge", image: "/photos/inventory/pont-barranc-morata.jpg" },
  { id: "pont-raco-duc-2", lat: 38.87967, lon: -0.26698, name: "Pont núm. 2 del Racó del Duc", group: "bridge", image: "/photos/inventory/pont-raco-duc-2.jpg" },
  { id: "pont-raco-duc-1", lat: 38.87868, lon: -0.26736, name: "Pont núm. 1 del Racó del Duc", group: "bridge", image: "/photos/inventory/pont-raco-duc-1.jpg" },
  { id: "pont-barranquet-plana", lat: 38.87555, lon: -0.27076, name: "Pont del Barranquet de la Plana", group: "bridge", image: "/photos/inventory/pont-barranquet-plana.jpg" },
  { id: "pont-salt-majones", lat: 38.87366, lon: -0.27745, name: "Pont del Salt de les Majones", group: "bridge", image: "/photos/inventory/pont-salt-majones.jpg" },
  { id: "pont-barranc-infern-2", lat: 38.86987, lon: -0.29181, name: "Pont del barranc de l'Infern núm. 2", group: "bridge", image: "/photos/inventory/pont-barranc-infern-2.jpg" },
  { id: "pont-barranc-infern-1", lat: 38.86954, lon: -0.29286, name: "Pont del barranc de l'Infern núm. 1", group: "bridge" },
  { id: "pont-barranc-mossen-vicent", lat: 38.72839, lon: -0.44382, name: "Pont del barranc Mossèn Vicent", group: "bridge" },
  { id: "tunel-1", lat: 38.72583, lon: -0.44489, name: "Túnel nº 1", group: "tunnel", image: "/photos/inventory/tunel-1.jpg" },
  { id: "tunel-2", lat: 38.818, lon: -0.37596, name: "Túnel nº 2", group: "tunnel", image: "/photos/inventory/tunel-2.jpg" },
  { id: "tunel-3", lat: 38.84417, lon: -0.333996, name: "Túnel nº 3", group: "tunnel" },
  ...
  { id: "diposit-aigua-beniarres", lat: 38.819, lon: -0.38308, name: "Dipòsit d'aigua de Beniarrés", group: "depot", lost: true },
  ...
  { id: "diposit-locomotores-alcoi", lat: 38.70638, lon: -0.47178, name: "Dipòsit de locomotores d'Alcoi", group: "depot", lost: true, image: "/photos/inventory/diposit-locomotores-alcoi.jpg" },
...
const municipalityByPoint: Record<string, string> = {
  ...
  alcoi: "Alcoi",
  "segona-estacio-alcoi": "Alcoi",
  "pont-ferro": "Gandia",
  "pont-tancaes": "Vilallonga",
  "pont-tarraso": "Vilallonga",
  "pont-garrofera": "l'Orxa",
  "pont-beniarres": "Beniarrés",
  "gran-pont-muro": "Muro d'Alcoi",
  "pont-barranc-morata": "Potries",
  "pont-raco-duc-2": "Vilallonga",
  "pont-raco-duc-1": "Vilallonga",
  "pont-barranquet-plana": "l'Orxa",
  "pont-salt-majones": "l'Orxa",
  "pont-barranc-infern-2": "l'Orxa",
  "pont-barranc-infern-1": "l'Orxa",
  "pont-barranc-mossen-vicent": "Cocentaina",
  "tunel-1": "Cocentaina",
  "tunel-2": "Beniarrés",
  "tunel-3": "l'Orxa",
  "tunel-4": "l'Orxa",
  ...
  "diposit-aigua-beniarres": "Beniarrés",
  "diposit-aigua-raco-duc": "l'Orxa",
  "diposit-locomotores-alcoi": "Alcoi",
...
const ROUTE_POSITION: Record<string, number> = {
  alcoi: 0,
  "segona-estacio-alcoi": 0,
  "diposit-locomotores-alcoi": 0,
  "caseta-algars": 19,
  "pont-barranc-mossen-vicent": 22,
  ...
  "pont-barranc-infern-1": 237,
  "pont-barranc-infern-2": 238,
  "diposit-aigua-raco-duc": 238,
  "pont-salt-majones": 251,
  "pont-garrofera": 248,
  "caseta-garrofera": 250,
  "tunel-5": 252,
  "pont-barranquet-plana": 256,
  "tunel-6": 259,
  "pont-raco-duc-1": 263,
  "pont-raco-duc-2": 265,
  "caseta-raco-duc": 266,
...
const copy = {
  va: {
    ...
    mapCaption: "De la muntanya al port de Gandia", mapHint: "Amplia el mapa o toca un grup per descobrir les parades.", back: "Tornar a la ruta", listen: "Escoltar l'audioguia", audioSoon: "Àudio disponible", heritage: "Patrimoni ferroviari", viewPoint: "Veure punt", wikilocEyebrow: "Ruta GPS", wikilocTitle: "Vols seguir la ruta amb Wikiloc?", wikilocText: "Obri l’itinerari complet al teu mòbil i segueix el traçat de l’antiga línia Alcoi–Gandia.", wikilocAction: "Obrir la ruta en Wikiloc", surveyEyebrow: "La teua opinió", surveyTitle: "Ajuda'ns a millorar l'experiència", surveyText: "Respon esta breu enquesta i comparteix amb nosaltres la teua opinió sobre el projecte.", surveyAction: "Respondre l'enquesta", incidentEyebrow: "Avís sobre la ruta", incidentTitle: "Has trobat alguna incidència?", incidentText: "Indica'ns si has trobat algun element malmés, un pas inaccesible o qualsevol altra incidència al recorregut.", incidentType: "Tipus d'incidència", incidentTypePlaceholder: "Selecciona una opció", incidentTypeDamage: "Element patrimonial malmés", incidentTypeAccess: "Pas o accés amb problemes", incidentTypeSignage: "Senyalització incorrecta o absent", incidentTypeOther: "Una altra incidència", incidentLocation: "Lloc o punt aproximat", incidentLocationPlaceholder: "Per exemple: túnel núm. 2", incidentDescription: "Explica'ns què has trobat", incidentDescriptionPlaceholder: "Afig els detalls que consideres importants…", incidentAction: "Enviar incidència", incidentThanks: "Gràcies per avisar-nos. Hem registrat la incidència.",
  ...
  es: {
    ...
    mapCaption: "De la montaña al puerto de Gandía", mapHint: "Amplía el mapa o toca un grupo para descubrir las paradas.", back: "Volver a la ruta", listen: "Escuchar la audioguía", audioSoon: "Audio disponible", heritage: "Patrimonio ferroviario", viewPoint: "Ver punto", wikilocEyebrow: "Ruta GPS", wikilocTitle: "¿Quieres seguir la ruta con Wikiloc?", wikilocText: "Abre el itinerario completo en tu móvil y sigue el trazado de la antigua línea Alcoy–Gandía.", wikilocAction: "Abrir la ruta en Wikiloc", surveyEyebrow: "Tu opinión", surveyTitle: "Ayúdanos a mejorar la experiencia", surveyText: "Responde esta breve encuesta y comparte con nosotros tu opinión sobre el proyecto.", surveyAction: "Responder la encuesta", incidentEyebrow: "Aviso sobre la ruta", incidentTitle: "¿Has encontrado alguna incidencia?", incidentText: "Indícanos si has encontrado algún elemento deteriorado, un paso inaccesible o cualquier otra incidencia en el recorrido.", incidentType: "Tipo de incidencia", incidentTypePlaceholder: "Selecciona una opción", incidentTypeDamage: "Elemento patrimonial deteriorado", incidentTypeAccess: "Paso o acceso con problemas", incidentTypeSignage: "Señalización incorrecta o ausente", incidentTypeOther: "Otra incidencia", incidentLocation: "Lugar o punto aproximado", incidentLocationPlaceholder: "Por ejemplo: túnel n.º 2", incidentDescription: "Cuéntanos qué has encontrado", incidentDescriptionPlaceholder: "Añade los detalles que consideres importantes…", incidentAction: "Enviar incidencia", incidentThanks: "Gracias por avisarnos. Hemos registrado la incidencia.",
  ...
  en: {
    ...
    mapCaption: "From the mountains to Gandia port", mapHint: "Zoom into the map or tap a cluster to discover the stops.", back: "Back to the route", listen: "Listen to the audio guide", audioSoon: "Audio available", heritage: "Railway heritage", viewPoint: "View place", wikilocEyebrow: "GPS route", wikilocTitle: "Would you like to follow the route with Wikiloc?", wikilocText: "Open the complete itinerary on your phone and follow the former Alcoy–Gandia railway line.", wikilocAction: "Open the route in Wikiloc", surveyEyebrow: "Your opinion", surveyTitle: "Help us improve the experience", surveyText: "Take this short survey and share your thoughts about the project with us.", surveyAction: "Take the survey", incidentEyebrow: "Route notice", incidentTitle: "Have you found an issue?", incidentText: "Let us know if you found a damaged heritage item, an inaccessible section or any other issue along the route.", incidentType: "Type of issue", incidentTypePlaceholder: "Choose an option", incidentTypeDamage: "Damaged heritage item", incidentTypeAccess: "Path or access problem", incidentTypeSignage: "Incorrect or missing signposting", incidentTypeOther: "Another issue", incidentLocation: "Place or approximate point", incidentLocationPlaceholder: "For example: tunnel no. 2", incidentDescription: "Tell us what you found", incidentDescriptionPlaceholder: "Add any details you consider important…", incidentAction: "Send issue", incidentThanks: "Thank you for letting us know. The issue has been recorded.",
...
export default function Home() {
  ...
  return <><main className="route-page">
    ...
    <section className="explorer" aria-labelledby="explorer-title">
      ...
      <section className="incident-card" aria-labelledby="incident-title"><div className="incident-intro"><span className="incident-symbol" aria-hidden="true">!</span><div><span className="eyebrow">{t.incidentEyebrow}</span><h2 id="incident-title">{t.incidentTitle}</h2><p>{t.incidentText}</p></div></div><form className="incident-form" onSubmit={(event) => { event.preventDefault(); setIncidentSent(true); }}><label><span>{t.incidentType}</span><select required defaultValue=""><option value="" disabled>{t.incidentTypePlaceholder}</option><option value="damage">{t.incidentTypeDamage}</option><option value="access">{t.incidentTypeAccess}</option><option value="signage">{t.incidentTypeSignage}</option><option value="other">{t.incidentTypeOther}</option></select></label><label><span>{t.incidentLocation}</span><input type="text" placeholder={t.incidentLocationPlaceholder} /></label><label className="incident-description"><span>{t.incidentDescription}</span><textarea required rows={4} placeholder={t.incidentDescriptionPlaceholder} /></label><div className="incident-submit"><button type="submit">{t.incidentAction}<span aria-hidden="true">→</span></button>{incidentSent && <p role="status">{t.incidentThanks}</p>}</div></form></section>
    </section>
  </main>
...
function AudioCard({ lang, src }: { lang: Lang; src: string }) {
  const t = copy[lang];
  return <div className="audio-card"><span className="play" aria-hidden="true">▶</span><span><strong>{t.listen}</strong><small>{t.audioSoon}</small></span><audio controls preload="metadata" aria-label={t.listen}><source src={assetPath(src)} type="audio/mp4" /></audio></div>;
}
...
function WelcomeDetail({ lang, onBack, onLanguage }: { lang: Lang; onBack: () => void; onLanguage: (lang: Lang) => void }) {
  ...
  return <div className="detail-modal-content"><DetailHeader lang={lang} onBack={onBack} onLanguage={onLanguage} /><article className="welcome-detail"><div className="welcome-hero"><span className="eyebrow">1893 — 1969</span><strong>{t.title}</strong><div className="rail-line" aria-hidden="true"><i /><i /><i /><i /></div></div><div className="welcome-body"><span className="eyebrow">{t.route}</span><h1>{guide.title}</h1><AudioCard lang={lang} src={welcomeAudio} /><p className="intro-lead">{guide.paragraphs[0]}</p><div className="history-stats"><div><strong>1893</strong><span>{lang === "en" ? "Opening" : lang === "es" ? "Inauguración" : "Inauguració"}</span></div><div><strong>76</strong><span>{lang === "en" ? "Years in service" : lang === "es" ? "Años en servicio" : "Anys de servei"}</span></div><div><strong>3</strong><span>{lang === "en" ? "Counties" : lang === "es" ? "Comarcas" : "Comarques"}</span></div></div><section className="guide-info welcome-guide">{guide.paragraphs.slice(1).map((paragraph) => <p key={paragraph}>{paragraph}</p>)}</section></div></article></div>;
}
